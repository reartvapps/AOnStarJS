...
import { OnStarConfig, Result, AlertRequestOptions, DiagnosticsRequestOptions, SetChargingProfileRequestOptions, DoorRequestOptions, TrunkRequestOptions, ChargeOverrideOptions } from "./types";
declare class OnStar {
    ...
    unlockTrunk(options?: TrunkRequestOptions): Promise<Result>;
